...
export default function ProductReviews(props) {
	...
	function handleSubmit() {
		let newReview = {
			comentario: review,
			puntuacion: qualify,
			usuario: user, // Falta obtener el id del usuario logueado para mandarle al back al crear comentario
			producto: _id,
		};
...
// Tebes que ver de donde sacar el id del usuario logueado, porque en el localStorage no esta
