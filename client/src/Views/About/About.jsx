...
function Integrante({ nombre, pais, imagen}) {
  ...
  return (
    <Col xs={6} sm={3} className="d-flex justify-content-around align-items-center mb-3  ">
      ...
      <img src={imagen} alt="foto persona" className={`rounded-circle mb-2 img-fluid w-50 ${styles.imgPerfil} `}></img>
  ...
  return (
    <div>
      ...
      <div className={` home-wrapper-2 ${styles.aboutContainer}`}>
        ...
        <h1 className=' text-center fw-bold pt-5 pb-1'>¡El equipo detrás de este hermoso proyecto!</h1>
