                      ...
                      <div className='col-3'>
                        <div className={`${style.filterCard} mb-3 p-3`}>
                            <div className='service-filter mb-4'>
                              <select value={filterService} onChange={(e) => handlerFilterByService(e)} class="form-select form-select-lg mb-3" aria-label=".form-select-lg">
                            ...
                            <div className='location-filter'>
                              <select value={filterLocation} onChange={(e) => handlerFilterByLocation(e)} class="form-select form-select-lg mb-3" aria-label=".form-select-lg">
                      ...
                      <div className='col-9'>
                        <div className={`${style.filterSortGrid} mb-4 p-2`}>
                            <div className='d-flex justify-content-between align-items-center flex-wrap'>
                              ...
                              <div className='d-flex align-items-center gap-10'>
                                  <p className='mb-0' style={{ width: "200px"}}>Buscar Servicio</p>
