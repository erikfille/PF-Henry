						...
						<div className={`accordion-item my-4 ${styles.questionContainer}`}>
							...
							<div
								...
								<div className={`accordion-body ${styles.response}`}>
									...
									tanto para perros como para gatos. Desde alimentos de alta calidad hasta
									juguetes y accesorios, ¡seguro que encontrará algo que le guste para su
									mascota!
								</div>
							</div>
						</div>
						<div className={`accordion-item my-4 ${styles.questionContainer}`}>
							...
							<div
								...
								<div className="accordion-body">
									...
									mejor opción de alimento para su perro. Puede comunicarse con nosotros
									por correo electrónico o por teléfono para obtener más información.
								</div>
							</div>
						</div>
						<div className={`accordion-item my-4 ${styles.questionContainer}`}>
						...
						<div className={`accordion-item my-4 ${styles.questionContainer}`}>
							...
							<div
								...
								<div className="accordion-body">
									...
									mascota. Comuníquese con nosotros para obtener más información.
								</div>
							</div>
						</div>
					</div>
