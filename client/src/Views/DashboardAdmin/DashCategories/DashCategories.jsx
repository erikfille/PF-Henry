                     ...
                     <tbody>
                        {
                           Categories.map((cat) => (
                              <tr>
                                 ...
                                 <td>{cat.type}</td>
                                 <td className='status'>
                                    <div className={`${style.status} ${ cat.status === "activo" ? style.active : style.inactive} ms-4 mt-2`}></div>
                                 </td>
                                 <td>
               ...
               <div className={style.addCategory}>
                  ...
                  <div class="mb-3 my-5 d-flex gap-30">
                     <div className="name">
                        ...
                        <input type="text" className="form-control" id="nombre" placeholder="Ingresa un nombre"
                        style={{
                           backgroundColor: "transparent",
                           color: "var(--body_color)",
                           border: "0.5px solid var(--border_color)",
                     ...
                     <div className="tipo">
                        <label for="nombre" className="form-label">Tipo</label>
                        <select 
